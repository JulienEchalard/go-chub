...
try {
const response = await fetch("assets/protocoles.json", {
cache: "no-store"
});
...
subtitle: `Protocole · ${document.category}`,
href: document.href,
keywords: `${document.title} ${document.category} protocole pdf`,
external: true
});
});
} catch (error) {
console.log("Impossible de charger les protocoles.");
}
}
